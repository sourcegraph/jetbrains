...
class HistoryStateTest : TestCase() {
  ...
  fun `test deserialization has no breaking changes between config versions`() {
    /**
     * Explanation: Setting files (config/options/cody_history.xml) contain internal class names as
     * tags, similar to <list><ChatState/></list>. The following assertions are there to ensure that
