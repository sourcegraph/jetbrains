...
interface CodyAgentServer {
  ...
  @JsonRequest("chat/new") fun chat_new(params: Null?): CompletableFuture<String>
  ...
  @JsonRequest("commands/explain") fun commands_explain(params: Null?): CompletableFuture<String>

  @JsonRequest("commands/test") fun commands_test(params: Null?): CompletableFuture<String>

  @JsonRequest("commands/smell") fun commands_smell(params: Null?): CompletableFuture<String>
  ...
  fun editTask_getFoldingRanges(
      params: GetFoldingRangeParams
  ): CompletableFuture<GetFoldingRangeResult>
  ...
  @JsonRequest("graphql/logEvent") fun graphql_logEvent(params: Event): CompletableFuture<Null?>
  ...
  fun graphql_getRepoIdIfEmbeddingExists(
  ...
  fun testing_diagnostics(
      params: Testing_DiagnosticsParams
  ): CompletableFuture<Testing_DiagnosticsResult>

  @JsonRequest("testing/progressCancelation")
  fun testing_progressCancelation(
      params: Testing_ProgressCancelationParams
  ): CompletableFuture<Testing_ProgressCancelationResult>

  @JsonRequest("testing/reset") fun testing_reset(params: Null?): CompletableFuture<Null?>
  ...
  fun textDocument_change(
      params: ProtocolTextDocument
  ): CompletableFuture<TextDocument_ChangeResult>

  @JsonRequest("attribution/search")
  fun attribution_search(
      params: Attribution_SearchParams
  ...
  @JsonNotification("$/cancelRequest") fun cancelRequest(params: CancelParams)
  ...
  @JsonNotification("progress/cancel") fun progress_cancel(params: Progress_CancelParams)
}
