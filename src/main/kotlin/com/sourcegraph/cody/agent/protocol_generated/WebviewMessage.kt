    ...
    val deserializer: JsonDeserializer<WebviewMessage> =
        JsonDeserializer { element: JsonElement, _: Type, context: JsonDeserializationContext ->
          when (element.getAsJsonObject().get("command").getAsString()) {
            "ready" ->
                context.deserialize<ReadyWebviewMessage>(element, ReadyWebviewMessage::class.java)
            "initialized" ->
                context.deserialize<InitializedWebviewMessage>(
                    element, InitializedWebviewMessage::class.java)
            "event" ->
                context.deserialize<EventWebviewMessage>(element, EventWebviewMessage::class.java)
            "recordEvent" ->
                context.deserialize<RecordEventWebviewMessage>(
                    element, RecordEventWebviewMessage::class.java)
            "submit" ->
                context.deserialize<SubmitWebviewMessage>(element, SubmitWebviewMessage::class.java)
            "history" ->
                context.deserialize<HistoryWebviewMessage>(
                    element, HistoryWebviewMessage::class.java)
            "restoreHistory" ->
                context.deserialize<RestoreHistoryWebviewMessage>(
                    element, RestoreHistoryWebviewMessage::class.java)
            "deleteHistory" ->
                context.deserialize<DeleteHistoryWebviewMessage>(
                    element, DeleteHistoryWebviewMessage::class.java)
            "links" ->
                context.deserialize<LinksWebviewMessage>(element, LinksWebviewMessage::class.java)
            "openURI" ->
                context.deserialize<OpenURIWebviewMessage>(
                    element, OpenURIWebviewMessage::class.java)
            "show-page" ->
                context.deserialize<`show-pageWebviewMessage`>(
                    element, `show-pageWebviewMessage`::class.java)
            "chatModel" ->
                context.deserialize<ChatModelWebviewMessage>(
                    element, ChatModelWebviewMessage::class.java)
            "get-chat-models" ->
                context.deserialize<`get-chat-modelsWebviewMessage`>(
                    element, `get-chat-modelsWebviewMessage`::class.java)
            "openFile" ->
                context.deserialize<OpenFileWebviewMessage>(
                    element, OpenFileWebviewMessage::class.java)
            "openLocalFileWithRange" ->
                context.deserialize<OpenLocalFileWithRangeWebviewMessage>(
                    element, OpenLocalFileWithRangeWebviewMessage::class.java)
            "edit" ->
                context.deserialize<EditWebviewMessage>(element, EditWebviewMessage::class.java)
            "context/get-remote-search-repos" ->
                context.deserialize<`context_get-remote-search-reposWebviewMessage`>(
                    element, `context_get-remote-search-reposWebviewMessage`::class.java)
            "context/choose-remote-search-repo" ->
                context.deserialize<`context_choose-remote-search-repoWebviewMessage`>(
                    element, `context_choose-remote-search-repoWebviewMessage`::class.java)
            "context/remove-remote-search-repo" ->
                context.deserialize<`context_remove-remote-search-repoWebviewMessage`>(
                    element, `context_remove-remote-search-repoWebviewMessage`::class.java)
            "embeddings/index" ->
                context.deserialize<Embeddings_indexWebviewMessage>(
                    element, Embeddings_indexWebviewMessage::class.java)
            "symf/index" ->
                context.deserialize<Symf_indexWebviewMessage>(
                    element, Symf_indexWebviewMessage::class.java)
            "insert" ->
                context.deserialize<InsertWebviewMessage>(element, InsertWebviewMessage::class.java)
            "newFile" ->
                context.deserialize<NewFileWebviewMessage>(
                    element, NewFileWebviewMessage::class.java)
            "copy" ->
                context.deserialize<CopyWebviewMessage>(element, CopyWebviewMessage::class.java)
            "auth" ->
                context.deserialize<AuthWebviewMessage>(element, AuthWebviewMessage::class.java)
            "abort" ->
                context.deserialize<AbortWebviewMessage>(element, AbortWebviewMessage::class.java)
            "simplified-onboarding" ->
                context.deserialize<`simplified-onboardingWebviewMessage`>(
                    element, `simplified-onboardingWebviewMessage`::class.java)
            "getUserContext" ->
                context.deserialize<GetUserContextWebviewMessage>(
                    element, GetUserContextWebviewMessage::class.java)
            "queryContextItems" ->
                context.deserialize<QueryContextItemsWebviewMessage>(
                    element, QueryContextItemsWebviewMessage::class.java)
            "reset" ->
                context.deserialize<ResetWebviewMessage>(element, ResetWebviewMessage::class.java)
            "attribution-search" ->
                context.deserialize<`attribution-searchWebviewMessage`>(
                    element, `attribution-searchWebviewMessage`::class.java)
            "troubleshoot/reloadAuth" ->
                context.deserialize<Troubleshoot_reloadAuthWebviewMessage>(
                    element, Troubleshoot_reloadAuthWebviewMessage::class.java)
            "getAllMentionProvidersMetadata" ->
                context.deserialize<GetAllMentionProvidersMetadataWebviewMessage>(
                    element, GetAllMentionProvidersMetadataWebviewMessage::class.java)
            "experimental-unit-test-prompt" ->
                context.deserialize<`experimental-unit-test-promptWebviewMessage`>(
                    element, `experimental-unit-test-promptWebviewMessage`::class.java)
...
data class AuthWebviewMessage(
    ...
    val authKind:
        AuthKindEnum, // Oneof: signin, signout, support, callback, simplified-onboarding, offline
