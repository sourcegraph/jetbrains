...
class KotlinPsiRangeProvider : CodyPsiRangeProvider {
  override fun getDocumentableRange(project: Project, editor: Editor): DocumentableRange? {
    ...
    return DocumentableRange(
        documentableElement.textRange.startOffset, documentableElement.textRange.endOffset)
  }
  ...
  private fun findDocumentableElement(element: PsiElement): PsiElement? {
    ...
    return PsiTreeUtil.getParentOfType(
        element,
        KtNamedFunction::class.java as Class<PsiElement>,
        KtClass::class.java as Class<PsiElement>)
  }
}
