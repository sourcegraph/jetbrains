...
import com.sourcegraph.cody.auth.depracated.DeprecatedCodyAccount
import com.sourcegraph.cody.auth.depracated.DeprecatedCodyAccountManager
      ...
      if (token != null) {
        loadUserDetails(
            ...
            server) {
              ...
              DeprecatedCodyAccountManager.getInstance().updateAccountToken(codyAccount, token)
            }
      }
    }
  }
